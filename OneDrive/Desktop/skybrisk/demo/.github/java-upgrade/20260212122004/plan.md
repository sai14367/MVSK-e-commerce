...
## Project Information
- **Project path**: c:\Users\VENKATA SAI KUMAR\OneDrive\Desktop\skybrisk\demo
- **Working branch**: appmod/java-upgrade-20260212122004
...
- **Source JDK path (Java 17)**: C:\Users\VENKATA SAI KUMAR\.jdk\jdk-17.0.16\bin
- **Target JDK path (Java 21)**: C:\Users\VENKATA SAI KUMAR\.jdk\jdk-21.0.8\bin
- **Build tool type**: Maven
- **Build tool path**: C:\Users\VENKATA SAI KUMAR\.maven\maven-3.9.12\bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260212122004`.
